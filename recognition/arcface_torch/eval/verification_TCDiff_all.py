...
if 'duo' in hostname:
    ...
    # benchmarks = [('nd_twins',               '--network %s --model %s --target nd_twins --data-dir /experiments/bjgbiesseck/datasets/ND-Twins-2009-2010/images_DETECTED_FACES_RETINAFACE_scales=[0.25]_nms=0.4/imgs --protocol /experiments/bjgbiesseck/datasets/ND-Twins-2009-2010/TwinsChallenge_1.0.0/TwinsChallenge/data/TwinsPairTable.csv --facial-attributes /experiments/bjgbiesseck/datasets/ND-Twins-2009-2010/images_DETECTED_FACES_RETINAFACE_scales=[0.25]_nms=0.4/imgs_FACE_ATTRIB')
    #              ]
