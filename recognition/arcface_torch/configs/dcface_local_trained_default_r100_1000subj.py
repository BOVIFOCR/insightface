...
if uname.nodename == 'duo':
    ...
    config.val_dataset_dir = ['/datasets2/2nd_frcsyn_cvpr2024/datasets/real/3_BUPT-BalancedFace/race_per_7000_crops_112x112']
    config.val_protocol_path = ['/datasets2/2nd_frcsyn_cvpr2024/comparison_files/comparison_files/sub-tasks_1.1_1.2/bupt_comparison.txt']
